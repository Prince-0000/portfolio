...
const Navbar = () => {
  ...
  return (
    ...
    <div className = "text-white flex justify-between sticky top-0 z-50 bg-black items-center h-24 max-w-full mx-auto px-4">
      <h1><a href='/' alt='Home'className='w-full md:text-3xl text-2xl font-bold text-[#00df9a]'>PORTFOLIO</a></h1>
      ...
      <h1 className='w-full md:text-3xl text-2xl font-bold text-[#00df9a] m-4'>PORTFOLIO</h1>
        <ul className='uppercase p-4'>
          <li onClick={handleNav} className='p-4 border-b border-gray-600' ><a href='#home'>Home</a></li>
          <li onClick={handleNav} className='p-4 border-b border-gray-600' ><a href='#about'>About</a></li>
          <li onClick={handleNav} className='p-4 border-b border-gray-600' ><a href='#project'>Projects</a></li>
          <li onClick={handleNav} className='p-4 border-b border-gray-600' ><a href='#skills'>Skills</a></li>
          <li onClick={handleNav} className='p-4 border-b border-gray-600' ><a href='#footer'>Contact</a></li>
